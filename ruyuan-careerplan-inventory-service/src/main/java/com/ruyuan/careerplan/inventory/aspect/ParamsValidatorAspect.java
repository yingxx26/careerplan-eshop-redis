package com.ruyuan.careerplan.inventory.aspect;

import com.alibaba.fastjson.JSON;
import com.ruyuan.careerplan.common.exception.BaseBizException;
import com.ruyuan.careerplan.inventory.enums.InventoryErrorCodeEnum;
...
public class ParamsValidatorAspect {
     ...
     */
    @Pointcut("@annotation(com.ruyuan.careerplan.inventory.annotation.ParamsValidate)")
    ...
    public Object around(ProceedingJoinPoint point) throws Throwable {
        ...
        //查看入参
        log.info("请求参数名:{}，请求参数值:{}", JSON.toJSONString(parameterNames), JSON.toJSONString(parameterValues));
        ...
        for (Object parameterValue : parameterValues) {
            ...
            if (!CollectionUtils.isEmpty(validateResult)) {
                ...
                throw new BaseBizException(InventoryErrorCodeEnum.PARAM_CHECK_ERROR, sb.substring(0, sb.length()-1));
            }
        }
        try {
